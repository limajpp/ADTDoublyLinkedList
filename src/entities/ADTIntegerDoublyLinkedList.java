...
public class ADTIntegerDoublyLinkedList {
    private ADTDoublyIntegerNode start;
    private int elements;

    public ADTIntegerDoublyLinkedList() {
        start = null;
        elements = 0;
    }
    ...
    public void insertAtStart(int element) {
        ADTDoublyIntegerNode newNode = new ADTDoublyIntegerNode(element);
    ...
    public void insertAtEnd(int element) {
        ...
        ADTDoublyIntegerNode newNode = new ADTDoublyIntegerNode(element);
        ADTDoublyIntegerNode currentNode = start;
